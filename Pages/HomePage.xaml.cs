...
public partial class HomePage : INotifyPropertyChanged
{
    ...
    private bool _attributeEnable = false;
    ...
    public ObservableCollection<string> Languages { get; } = new() { "zh_CN", "zh_TW", "en_US", "es_ES" };
    public ObservableCollection<string> DatabaseMethods { get; } = new() { "JSON", "SQL" };
    public ObservableCollection<string> TeamPlugins { get; } = new() { "DungeonPlus" };
    public ObservableCollection<string> AttributePlugins { get; } = new() { "AttributePlus", "SX-Attribute", "OriginAttribute", "AttributeSystem" };
    ...
    public bool IsJsonSelected => SelectedDatabaseMethod == "JSON";
    public bool IsSqlSelected => SelectedDatabaseMethod == "SQL";
